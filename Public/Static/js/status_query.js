...
function Look(e,event) {
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            $("#sex").val(data[0]['sex']);
            $("#pinyin").val(data[0]['pinyin']);
            $("#wheremidd").val(data[0]['wheremidd']);
            $("#ticketnumber").val(data[0]['ticketnumber']);
            $("#nation").val(data[0]['nation_id']);
            $("#phone").val(data[0]['phone']);
            $("#birth").val(data[0]['birth']);
            $("#stu_class").val(data[0]['class']);
            $("#native").val(data[0]['native']);
            $("#domicile").val(data[0]['domicile']);
            $("#parent1_name").val(data[0]['parent1_name']);
            $("#parent1_idcard").val(data[0]['parent1_idcard']);
            $("#parent1_birth").val(data[0]['parent1_birth']);
            $("#parent1_guardian").val(data[0]['parent1_guardian']);
            $("#parent1_phone").val(data[0]['parent1_phone']);
            $("#parent2_name").val(data[0]['parent2_name']);
            $("#parent2_idcard").val(data[0]['parent2_idcard']);
            $("#parent2_birth").val(data[0]['parent2_birth']);
            $("#parent2_guardian").val(data[0]['parent2_guardian']);
            $("#parent2_phone").val(data[0]['parent2_phone']);
            $("#accounttype").val(data[0]['accounttype']);
            $("#allowances").val(data[0]['allowances']);
            $("#homecode").val(data[0]['homecode']);
            $("#homeaddr").val(data[0]['homeaddr']);
            $("#homepolice").val(data[0]['homepolice']);
            $("#source").val(data[0]['source_id']);
            $("#polity").val(data[0]['polity']);
            $("#grades").val(data[0]['grades']);
            $("#qq").val(data[0]['qq']);
