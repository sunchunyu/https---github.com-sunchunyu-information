    ...
    <div class="col-xs-12 col-md-12">
                <div class="widget">
                    <div class="widget-header ">
                        <span class="widget-caption"><i class="fa fa-table"></i>&nbsp;&nbsp;院系列表</span>
                    ...
                    <div class="widget-body">
                        ...
                        <div class="btn-group">
                            <button type="button" class="btn btn-default btn-add"
                                    data="<?php echo U('admin/dict/college_view',null,false,false,false);?>"><i
                            ...
                            <button type="button" class="btn btn-default btn-del"
                                    data="<?php echo U('admin/dict/college_delete',null,false,false,false);?>"><i
                                    class="fa fa-minus-square"></i> 删除
                            </button>
                            <button type="button" class="btn btn-primary btn-query" style="display: none;"
                                    data="<?php echo U('admin/dict/college_query',null,false,false,false);?>">
                        ...
                        <div role="grid" id="simpledatatable_wrapper" class="dataTables_wrapper form-inline no-footer">
                            ...
                            <input type="hidden" value="<?php echo U('Dict/college_query');?>" id="url"/>
                        </div>
                    </div>
                </div>
            </div>
...
<script src="/informationcollection/Public/assets/js/base.js"></script>
    ...
    <script src="/informationcollection/Public/Static/js/college_list.js" ></script>
