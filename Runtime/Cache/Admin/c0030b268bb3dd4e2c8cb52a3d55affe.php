                ...
                <div class="widget-body">
                    ...
                    <div class="btn-group">
                        <button type="button" class="btn btn-default btn-post"
                                data="<?php echo U('admin/stud/graduation_data',null,false,false,false);?>" style="display: none"><i
...
<script src="/informationcollection/Public/assets/js/base.js"></script>
    ...
    <script src="/informationcollection/Public/Static/js/graduation_summary.js"></script>
