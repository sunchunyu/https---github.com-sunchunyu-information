        ...
        <div class="col-xs-12 col-md-12">
            <div class="widget">
                <div class="widget-header ">
                    <span class="widget-caption"><i class="fa fa-pencil"></i>&nbsp;&nbsp;添加</span>
                ...
                <div class="widget-body">
                    ...
                    <div class="form" style="padding: 20px 0px;">
                        <form method="post" id="form" action="<?php echo U('/admin/stud/manage_add_save',null,false,false,false);?>">
                            ...
                            <div class="row" style="width: 400px;">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group" style="margin-bottom: 10px;">
                                            ...
                                            <span class="input-icon icon-right">
                                                <select style="width: 100%;" class="form-control getdata">
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group" style="margin-bottom: 10px;">
                                        <label class="setbounds">适用系别<span style="color: red">（*）</span></label>
                                            <span class="input-icon icon-right">
                                                 <select style="width: 100%;" class="form-control department">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group" style="margin-bottom: 10px;">
                                            <label class="setbounds">适用专业</label>
                                            <span class="input-icon icon-right">
                                               <select style="width: 100%;" class="form-control specialty">
                                                   <option value="0" data-parent="0">全部</option>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group" style="margin-bottom: 10px;">
                                            <label class="setbounds">适用班级</label>
                                            <span class="input-icon icon-right">
                                               <select style="width: 100%;" class="form-control class">
                                                   <option value="0" data-parent="0">全部</option>
...
<script src="/informationcollection/Public/assets/js/base.js"></script>
    ...
    <!--本页面JavaScript-->
    <script src="/informationcollection/Public/Static/js/manage_add_view.js"></script>
