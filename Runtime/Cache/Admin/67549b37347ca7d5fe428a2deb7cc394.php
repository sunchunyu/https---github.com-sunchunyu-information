        ...
        <div class="col-xs-12 col-md-12">
            <div class="widget">
                <div class="widget-header ">
                    <span class="widget-caption"><i class="fa fa-table"></i>&nbsp;&nbsp;省市区列表</span>
                ...
                <div class="widget-body">
                                ...
                                <div id="collapseOne" class="panel-collapse collapse">
                                    <div class="panel-body">
                                        ...
                                        <select  id="pro-list">
                                            ...
                                            <?php if(is_array($pro_data)): foreach($pro_data as $key=>$vo): ?><option value="<?php echo ($vo["Id"]); ?>"><?php echo ($vo["name"]); ?></option><?php endforeach; endif; ?>
                                        </select>
                                        ...
                                        <select   id="city-list">
                                            <option value="-1">未选</option>
                                            <?php if(is_array($city_data)): foreach($city_data as $key=>$vo): ?><option value="<?php echo ($vo["Id"]); ?>"><?php echo ($vo["name"]); ?></option><?php endforeach; endif; ?>
                                        </select>

                                        <label>名称</label>
                                            <input type="text" maxlength="20" class="form-control Name"
                                               placeholder="区名称" style="width: 150px;display: inline-block;">
                                        <button type="submit" class="btn btn-primary search" style="padding: 7px; margin-top: -3px;">
                    ...
                    <div class="btn-group">
                        <button type="button" class="btn btn-default btn-add"
                                data="<?php echo U('admin/dict/county_view',null,false,false,false);?>"><i
                        ...
                        <button type="button" class="btn btn-default btn-del"
                                data="<?php echo U('admin/dict/county_delete',null,false,false,false);?>"><i
                                class="fa fa-minus-square"></i> 删除
                        </button>
                        <!--获取到数据库的数据等待js使用-->
                        <button type="button" class="btn btn-primary btn-query" style="display: none;"
                                data="<?php echo U('admin/dict/county_query',null,false,false,false);?>">
                            <i class="fa fa-search"></i> 查询
                        </button>
                        <!--获取PHP路径-->
                        <button type="button" id="county-url" style="display: none;"
                                data="<?php echo U('admin/dict/county_initialize',null,false,false,false);?>">
                        </button>
                        <!--初始化按钮的按钮-->
                        <button type="button" class="btn btn-default btn-init">
...
<script src="/informationcollection/Public/assets/js/base.js"></script>
    ...
    <script src="/informationcollection/Public/Static/js/county_list.js"></script>
