                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4" style="margin-top: 10px">
                                    <span class="input-icon icon-right">
                                        <label>考试总分</label>
                                        <span class="input-icon icon-right">
                                             <input  disabled="disabled" id="totalscore" class="form-control" type="text" >
                                        </span>
                                    </span>
                            </div>
...
<script src="/informationcollection/Public/assets/js/Base.js"></script>
    ...
    <script src="/informationcollection/Public/Static/js/freshman_query.js" ></script>
