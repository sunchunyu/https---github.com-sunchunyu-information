        ...
        <div class="col-xs-12 col-md-12">
            <div class="widget">
                <div class="widget-header ">
                    <span class="widget-caption"><i class="fa fa-pencil"></i>&nbsp;&nbsp;省市区<?php echo ($title); ?></span>
                ...
                <div class="widget-body">
                    <div class="btn-group">
                        <a class="btn btn-default btn-add"
                           href="<?php echo U('admin/dict/county_list',null,false,false,false);?>"><i
                    ...
                    <div class="form" style="padding: 20px 0px;">
                        <form method="post" id="form" action="<?php echo U('admin/dict/county_save',null,false,false,false);?>">
                            <div class="form-title">
                                省市区详情
                            </div>
                            <div class="row" style="width: 400px;">

                                <lable data="<?php echo ($make); ?>" id="make" hideen></lable>        <!--标示全部的操作类型-->

                                <?php if($data == null ): ?><!--添加功能代码区域-->
                                    <lable data="<?php echo U('admin/dict/get_city',null,false,false,false);?>" id="get-city-rul" hidden></lable>
                                    <lable data="<?php echo U('admin/dict/county_save',null,false,false,false);?>" id="save-rul" hidden></lable>
                                        ...
                                        <div class="form-group" style="margin-bottom: 10px;">
                                            ...
                                            <span class="input-icon icon-right">
                                                 <select style="width: 100%;" class="form-control pro" id="pro-list" >
                                                     ...
                                                     <?php if(is_array($pro)): $i = 0; $__LIST__ = $pro;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><option value="<?php echo ($data["Id"]); ?>"><?php echo ($data["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                                 </select>
                                            </span>
                                        </div>
                                    </div>
                                ...
                                <?php else: ?>
                                    ...
                                    <sapn data="<?php echo U('admin/dict/edit_save',null,false,false,false);?>" id="edit-url" hideen ></sapn>
                                    <div class="col-sm-12">
                                        <div class="form-group" style="margin-bottom: 10px;">
                                            <label class="setbounds">所属省名称<span style="color: red">（*）</span></label>
                                            <span class="input-icon icon-right">
                                                <?php if($pro_flag == true ): ?><select style="width: 100%;" class="form-control edit-pro" >
                                                        <option value="0">请选择</option>
                                                ...
                                                <?php else: ?>
                                                    <select style="width: 100%;" class="form-control edit-pro" class="edit-pro-list" disabled>
                                                        <option value="0">请选择</option>
                                                    </select><?php endif; ?>
                                            </span>
                                        </div>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group" style="margin-bottom: 10px;">
                                            <label class="setbounds">所属市名称<span style="color: red">（*）</span></label>
                                            <span class="input-icon icon-right">
                                                <?php if($city_flag == true ): ?><select style="width: 100%;" class="form-control edit-city"  >
                                                        <option value="0">请选择</option>
                                                        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["Id"]); ?>"><?php echo ($vo["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                                    </select>
                                                <?php else: ?>
                                                    <select style="width: 100%;" class="form-control edit-city-list" disabled>
                                                        <option value="0">请选择</option>
                                                    </select><?php endif; ?>
                                            </span>
                                        </div>
                                        ...
                                        <div class="form-group" style="margin-bottom: 10px;">
                                            ...
                                            <span class="input-icon icon-right">
                                                <input type="text" maxlength="20" class="form-control Name"
                                                       placeholder="区名称" value="<?php echo ($data["text"]); ?>">
                                                <input class="id" type="hidden" value="<?php echo ($data["id"]); ?>"/>
                                                <i class="fa fa-bookmark"></i>
                                            </span>
                                        </div>
                                    </div><?php endif; ?>
...
<script src="/informationcollection/Public/assets/js/base.js"></script>
    ...
    <!--本页面JavaScript-->
    <script src="/informationcollection/Public/Static/js/county_view.js"></script>
