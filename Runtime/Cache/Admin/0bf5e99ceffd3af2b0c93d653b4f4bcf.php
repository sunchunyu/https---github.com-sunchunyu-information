...
<head lang="en">
    ...
    <!--本页面CSS-->
    <link href="/informationcollection/Public/Static/css/news_add.css" rel="stylesheet"/>
...
<div class="main-container container-fluid">
        ...
        <div class="col-xs-12 col-md-12">
            <div class="widget">
                <div class="widget-header ">
                    <span class="widget-caption"><i class="fa fa-pencil"></i>&nbsp;&nbsp;资讯<?php echo ($title); ?></span>
                ...
                <div class="widget-body">
                    <div class="btn-group">
                        <a class="btn btn-default btn-add"
                           href="<?php echo U('admin/Wx/news_list');?>"><i
                    ...
                    <div class="form" style="padding: 20px 0px;">
                        <form name="news_add" id="form" action="<?php echo U('admin/Wx/news_add_save');?>?id=<?php echo ($news['Id']); ?>"
                              method="post"
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    ...
                                    <div class="col-sm-8">
                                        ...
                                        <input type="hidden" id="cate_hide" value="<?php echo ($news['category_id']); ?>"/>
                                        <select class="form-control" id="category" name="category">
                                            <?php if(is_array($category_rs)): $i = 0; $__LIST__ = $category_rs;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cate): $mod = ($i % 2 );++$i;?><option value="<?php echo ($cate['Id']); ?>">
                                                    <?php echo ($cate['name']); ?>
                                    ...
                                    <div class="col-sm-8">
                                        ...
                                        <div style="display: block;border:1px solid #e0e0e0;padding: 5px 0px;">
                                            <?php if($news['type'] == 0): ?><div class="radio">
                                                        <label>
                                    ...
                                    <div class="col-sm-8" style="margin-top: 3px;">
                                        ...
                                        <input type="text" id="tags" data-role="tagsinput"
                                               placeholder="Add tags" name="tags" value="<?php echo ($news['tags']); ?>"/>
                                    </div>
                                    <div class="col-sm-8">
 ...
 if($news['thumb']){ echo $news['thumb']; }else{ }?>"
                                                   data="<?php echo ($token); ?>" name="img_up" readonly/>
                                    ...
                                    <div class="col-sm-8">
                                        <div>
                                            ...
                                            <textarea class="form-control" name="textarea" rows="3"
                                                      ...
                                                      style="resize:none" maxlength="100"><?php echo ($news['abstract']); ?></textarea>
                                        </div>
                                    </div>
                                    <div class="col-sm-8">
                                        <div id="ue">
                                            ...
                                            <textarea type="text/plain" id="myEditor"
                                                      ...
                                                      name="myEditor"><?php echo ($news['content']); ?></textarea>
                                    ...
                                    <div class="col-sm-8">
                                        <div class="container" style="margin: 0px;width: 100%;padding: 0px;">
                                            ...
                                            <input type="file" id="input-file-now" class="dropify" name="upload"
                                                   data-default-file="/informationcollection<?php echo ($news['attachment']); ?>"/>
                                            <br/>
                                        </div>
                                    </div>
                                </div>
...
<script src="/informationcollection/Public/assets/js/Base.js"></script>
    ...
    <script src="/informationcollection/Public/Static/js/news_add.js"></script>
