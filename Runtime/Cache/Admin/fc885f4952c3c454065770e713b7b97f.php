        ...
        <div class="col-xs-12 col-md-12">
            <div class="widget">
                <div class="widget-header ">
                    <span class="widget-caption"><i class="fa fa-table"></i>&nbsp;&nbsp;资讯信息列表</span>
                    <input type="hidden" value="<?php echo U('news_list');?>" id="home"/>
                ...
                <div class="widget-body">
                                            ...
                                            <td>
                                                <div class="input-group">
                                                    ...
                                                    <input class="form-control date-picker" id="id-date-picker-1"
                                                           ...
                                                           placeholder="请输入起始日期" style="width: 185px">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="input-group"
                                                    ...
                                                    <select id="e1" style="width:222px;">
                                                        <option value="0"/>
                                                        全部
                                                        <?php if(is_array($cate_rs)): $i = 0; $__LIST__ = $cate_rs;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo['Id']); ?>"><?php echo ($vo['name']); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                                    </select>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="input-group"
                                                     style="margin-bottom: 5px;;margin-top: 5px">
                                                    <span class="input-group-addon">资讯类型</span>
                                                    <select id="zixun" name="type_search" style="width: 222px">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="input-group">
                                                    ...
                                                    <input style="width: 222px;" type="text"
                                                           class="form-control input-sm s_input"
                                                           id="title" placeholder="请输入标题">
                                                    </span>
                                                </div>
                                            </td>
                                            <td>
                                                <a class="btn btn-primary" id="query"
                                                   style="padding: 7px;">
                    ...
                    <div class="btn-group">
                        <button type="button" class="btn btn-default news-add"
                                data="<?php echo U('admin/Wx/news_add');?>"><i
                                class="fa fa-plus-square"></i> 新增
                        </button>
                        <button type="button" class="btn btn-default btn-edit"
                                data="<?php echo U('admin/Wx/news_add',null,false,false,false);?>"><i
                                class="fa fa-pencil-square"></i> 编辑
                        </button>
                        <button type="button" class="btn btn-default btn-del"
                                data="<?php echo U('admin/Wx/news_del',null,false,false,false);?>"><i
                                class="fa fa-minus-square"></i> 删除
                        </button>

                    </div>
                    <div role="grid" id="news_add" class="dataTables_wrapper form-inline no-footer serverSide" style="margin-top: 8px;">
                        <table class="table table-striped table-bordered table-hover" id="list_table"
                               data="<?php echo U('admin/Wx/news_query',null,false,false,false);?>" count="<?php echo ($count); ?>">
                            <thead>
                            <tr>
                                <th>标题</th>
                                <th >资讯类别</th>
...
<script src="/informationcollection/Public/assets/js/Base.js"></script>
    ...
    <!--本页面JavaScript-->
    <script src="/informationcollection/Public/Static/js/news_list.js"></script>
    <!--本页面JavaScript-->
