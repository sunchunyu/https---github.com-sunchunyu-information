        ...
        <div class="col-xs-12 col-md-12">
            <div class="widget">
                <div class="widget-header ">
                    <span class="widget-caption"><i class="fa fa-pencil"></i>&nbsp;&nbsp;专业<?php echo ($title); ?></span>
                ...
                <div class="widget-body">
                    <div class="btn-group">
                        <a class="btn btn-default btn-add"
                           href="<?php echo U('admin/dict/specialty_list',null,false,false,false);?>"><i
                    ...
                    <div class="form" style="padding: 20px 0px;">
                        <form method="post" id="form" action="<?php echo U('admin/dict/specialty_save',null,false,false,false);?>">
                            <div class="form-title">
                                专业详情
                            </div>
                            <div class="row" style="width: 400px;">
                                <?php if($data == null ): ?><div class="col-sm-12">
                                        <div class="form-group" style="margin-bottom: 10px;">
                                            <label class="setbounds">专业名称<span style="color: red">（*）</span></label>
                                            <span class="input-icon icon-right">
                                                <input type="text" maxlength="20" class="form-control specialtyName"
                                                       placeholder="专业名称">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group" style="margin-bottom: 10px;">
                                            <label class="setbounds">所属院系<span style="color: red">（*）</span></label>
                                            <span class="input-icon icon-right">
                                                 <select style="width: 100%;" class="form-control college">
                                ...
                                <?php else: ?>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group" style="margin-bottom: 10px;">
                                            <label class="setbounds">专业名称<span style="color: red">（*）</span></label>
                                                <span class="input-icon icon-right">
                                                    <input type="text" class="form-control specialtyName" placeholder="专业名称"
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group" style="margin-bottom: 10px;">
                                           ...
                                           <span class="input-icon icon-right">
                                                <select style="width: 100%;" class="form-control college">
                                                    <option value="0">请选择所属院系</option>
                                                    <?php if(is_array($college)): foreach($college as $key=>$vo): if($data['college_id'] == $vo["Id"] ): ?><option value="<?php echo ($vo["Id"]); ?>" selected><?php echo ($vo["name"]); ?></option>
                                                        <?php else: ?>
...
<script src="/informationcollection/Public/assets/js/base.js"></script>
    ...
    <!--本页面JavaScript-->
    <script src="/informationcollection/Public/Static/js/specialty_view.js"></script>
