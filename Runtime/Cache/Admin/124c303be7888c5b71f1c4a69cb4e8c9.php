    ...
    <div class="col-xs-12 col-md-12">
                <div class="widget">
                    <div class="widget-header ">
                        <span class="widget-caption"><i class="fa fa-table"></i>&nbsp;&nbsp;专业列表</span>
                    ...
                    <div class="widget-body">
                                    ...
                                    <div id="collapseOne" class="panel-collapse collapse">
                                        <div class="panel-body">
                                            ...
                                            <select   id="college_0">
                                                ...
                                                <?php if(is_array($college_0)): foreach($college_0 as $key=>$vo): ?><option value="<?php echo ($vo["Id"]); ?>"><?php echo ($vo["name"]); ?></option><?php endforeach; endif; ?>
                                            </select>

                                            <label>院系</label>
                                            <select  id="college_1">
                                                <option value="0" data-parent = "0">全部</option>
                                                <?php if(is_array($college_1)): foreach($college_1 as $key=>$vo): ?><option value="<?php echo ($vo["Id"]); ?>" data-parent = "<?php echo ($vo["p_id"]); ?>"><?php echo ($vo["name"]); ?></option><?php endforeach; endif; ?>
                                            </select>

                                            <button type="submit" class="btn btn-primary" style="padding: 7px; margin-top: -3px;">
                        ...
                        <div class="btn-group">
                            <button type="button" class="btn btn-default btn-add"
                                    data="<?php echo U('admin/dict/specialty_view',null,false,false,false);?>"><i
                            ...
                            <button type="button" class="btn btn-default btn-del"
                                    data="<?php echo U('admin/dict/specialty_delete',null,false,false,false);?>"><i
                                    class="fa fa-minus-square"></i> 删除
                            </button>
                            <button type="button" class="btn btn-primary btn-query" style="display: none;"
                                    data="<?php echo U('admin/dict/specialty_query',null,false,false,false);?>">
                        ...
                        <div role="grid" id="simpledatatable_wrapper" class="dataTables_wrapper form-inline no-footer">
                            ...
                            <input type="hidden" value="<?php echo U('Dict/specialty_query');?>" id="url"/>
                        </div>
                    </div>
                </div>
            </div>
...
<script src="/informationcollection/Public/assets/js/base.js"></script>
    ...
    <script src="/informationcollection/Public/Static/js/specialty_list.js" ></script>
