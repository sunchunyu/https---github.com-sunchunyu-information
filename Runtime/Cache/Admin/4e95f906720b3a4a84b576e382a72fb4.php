        ...
        <div class="col-xs-12 col-md-12">
            <div class="widget">
                <div class="widget-header">
                    <span class="widget-caption"><i class="fa fa-table"></i>&nbsp;&nbsp;信息采集列表</span>
                ...
                <div class="widget-body">
                                    ...
                                    <div class="panel-body">
                                        <table>
                                            <tr>
                                                <td>
                                                    <label>学院</label>
                                                    <select id="college" style="width: 192px;">
                                                    ...
                                                    <label>系别</label>
                                                    <select id="deparment" style="width: 195px">
                                                        <option value="0" data-parent="0">全部</option>
                                                        <?php if(is_array($deparment)): foreach($deparment as $key=>$vo): ?><option value="<?php echo ($vo["Id"]); ?>" data-parent="<?php echo ($vo["p_id"]); ?>">
                                                                <?php echo ($vo["name"]); ?>
                                                    ...
                                                    <select id="specialty">
                                                        <option value="0" data-parent="0">全部</option>
                                                        <?php if(is_array($specialty)): foreach($specialty as $key=>$vo): ?><option value="<?php echo ($vo["Id"]); ?>" data-parent="<?php echo ($vo["college_id"]); ?>">
                                                                <?php echo ($vo["name"]); ?>
                                                            </option><?php endforeach; endif; ?>
                                                    </select>
                                                </td>
                                            ...
                                            <tr>
                                                <td>
                                                    <label>班级</label>
                                                    <select id="class" style="width: 192px;">
                                                        <option value="0" data-parent="0">全部</option>
                                                        <?php if(is_array($class)): foreach($class as $key=>$vo): ?><option value="<?php echo ($vo["Id"]); ?>" data-parent="<?php echo ($vo["specialty_id"]); ?>">
                                                                <?php echo ($vo["name"]); ?>
                                                            </option><?php endforeach; endif; ?>
                                                    </select>

                                                    <label>采集类型</label>
                                                    <select id="code" style="min-width: 129px">
                                                        <option value="0">全部</option>
                                                        <option value="1">新生数据采集</option>
                                                        <option value="2">学籍数据采集</option>
                                                        <option value="3">毕业生数据信息采集</option>
                                                    </select>

                                                    <label>状态</label>
                                                    <select id="status" style="width: 158px">
                                            ...
                                            <tr>
                                                <td>
                                                    <label>名称</label><input type="text" id="student_name"
                                                                            placeholder="名称"
                    ...
                    <div class="btn-group">
                        <button type="button" class="btn btn-default btn-add"
                                data="<?php echo U('admin/stud/manage_add_view',null,false,false,false);?>"><i
                                class="fa fa-plus-square"></i> 新增
                        </button>
                        <button type="button" class="btn btn-default btn-edit"
                                data="<?php echo U('admin/stud/manage_edit_view',null,false,false,false);?>"><i
                                class="fa fa-pencil-square"></i> 编辑
                        </button>
                        <button type="button" class="btn btn-default btn-del"
                                data="<?php echo U('admin/stud/manage_delete',null,false,false,false);?>"><i
                                class="fa fa-minus-square"></i> 删除
                        </button>
                        <button type="button" class="btn btn-primary btn-query" style="display: none;"
                                data="<?php echo U('admin/Stud/get_data',null,false,false,false);?>">
                            <i class="fa fa-search"></i> 数据信息
                        </button>

                        <button type="button" class="btn btn-primary btn-status" style="display: none;"
                                data="<?php echo U('admin/stud/change_status',null,false,false,false);?>">
...
<script src="/informationcollection/Public/assets/js/Base.js"></script>
    ...
    <script src="/informationcollection/Public/assets/js/code/clipboard.min.js"></script>
    <script src="/informationcollection/Public/assets/js/toastr/toastr.js"></script>
    <script src="/informationcollection/Public/Static/js/manage_list.js"></script>
