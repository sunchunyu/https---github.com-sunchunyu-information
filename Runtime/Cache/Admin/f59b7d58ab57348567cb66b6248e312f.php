        ...
        <div class="col-xs-12 col-md-12">
            <div class="widget">
                <div class="widget-header ">
                    <span class="widget-caption"><i class="fa fa-table"></i>&nbsp;&nbsp;资讯类别列表</span>
                ...
                <div class="widget-body">
                    <div class="btn-group">
                        <button type="button" class="btn btn-default category-add"
                                data="<?php echo U('admin/wx/category_add',null,false,false,false);?>">
                            <i class="fa fa-plus-square"></i> 新增
                        </button>
                        <button type="button" class="btn btn-default btn-edit"
                                data="<?php echo U('admin/wx/category_add',null,false,false,false);?>"><i
                                class="fa fa-pencil-square"></i> 编辑
                        </button>
                        <button type="button" class="btn btn-default btn-del"
                                data="<?php echo U('admin/wx/category_delete',null,false,false,false);?>"><i
                                class="fa fa-minus-square"></i> 删除
                        </button>
                        <button type="button" class="btn btn-primary btn-query" style="display: none"
                                data="<?php echo U('admin/wx/category_query',null,false,false,false);?>">
                            <i class="fa fa-search"></i> 查询
                        </button>
                        <input type="hidden" value="<?php echo U('admin/wx/category_desktop',null,false,false,false);?>"
                               id="desktop"/>
                    </div>
...
<script src="/informationcollection/Public/assets/js/Base.js"></script>
    ...
    <script src="/informationcollection/Public/Static/js/category_list.js"></script>
